...
const BillDetails = ({ bill, onBack }) => {
  ...
  return (
    <div className="bg-[#438883] flex flex-col font-sans relative">
      ...
      <div className="bg-white grow rounded-t-[40px] px-8 pt-10 pb-4 relative z-10 -mt-32 top-12 flex flex-col shadow-2xl">
